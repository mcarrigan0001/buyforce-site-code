...
(function () {
  ...
  function bfPipeRender(R){
    ...
    R.innerHTML='<div id="bff-wrap"><div class="bff-head"><div class="bff-titlerow"><span class="bff-title bff-glow">COMMAND CENTER</span></div><span class="bff-scope" data-r="scope"></span><div class="bff-rt"><span class="bff-masterrep" data-r="masterrep"></span><div class="bff-sectoggles"><button class="bff-sectg on" data-sec="kpis" type="button"><i class="ti ti-gauge"></i>KPIs</button><button class="bff-sectg on" data-sec="extras" type="button" title="Leaderboard & Reports"><i class="ti ti-chart-histogram"></i></button></div><div class="bff-tabs"><button class="bff-tab on" data-view="macro">Milestones</button><button class="bff-tab" data-view="stages">All stages</button></div></div></div><div class="bff-kpis" data-r="kpis"></div><div class="bff-extras"><div class="bff-actpanel" data-r="actpanel"></div><div class="bff-perfpanel" data-r="perf"></div><div class="bff-reportpanel" data-r="report"></div></div><div class="bff-funnel" data-r="funnel"><div class="bff-load">Loading pipeline…</div></div><div class="bff-caret" data-r="caret" style="display:none;" title="Show all opportunities"><i class="ti ti-chevron-down" aria-hidden="true"></i></div></div><div class="bff-listcard" data-r="lc"></div>'; (function(){ try{ var pe=R; for(var i=0;i<9 && pe;i++){ var cs=getComputedStyle(pe); if(cs.maxWidth && cs.maxWidth.indexOf('%')>-1){ pe.style.maxWidth='min(1180px, 98vw)'; pe.style.width='100%'; break; } pe=pe.parentElement; } }catch(e){} })(); (function(){ [].forEach.call(R.querySelectorAll('.bff-sectg'),function(b){ b.addEventListener('click',function(){ var sec=b.getAttribute('data-sec'); var tg=(sec==='kpis')?q('kpis'):R.querySelector('.bff-extras'); var on=b.classList.toggle('on'); if(tg) tg.style.display=on?'':'none'; }); }); })();
    ...
    function bfPipeKPI(){
      ...
      function bfPipeReports(){
        ...
        var cap=''; if(st.repIcon!=null && ['conversion','vehicles','acquisition','velocity'].indexOf(which)>-1 && U[st.repIcon]){ var su=U[st.repIcon]; cap='<div class="bff-rcap">'+su.count+' '+esc2(su.label)+' out of '+reached(0)+' leads</div>'; }
