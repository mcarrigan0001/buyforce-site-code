...
(function () {
  ...
  function bfPipeRender(R){
    ...
    R.innerHTML='<div id="bff-wrap"><div class="bff-head"><span class="bff-title bff-glow">Pipeline Summary</span><span class="bff-scope" data-r="scope"></span><div class="bff-rt"><button class="bff-filter" data-r="fbtn"><i class="ti ti-plus" style="color:#57c822;font-size:15px;" aria-hidden="true"></i>Filter</button><div class="bff-tabs"><button class="bff-tab on" data-view="macro">Milestones</button><button class="bff-tab" data-view="stages">All stages</button></div></div></div><div class="bff-kpis" data-r="kpis"></div><div class="bff-fpanel" data-r="fpanel" style="display:none;"></div><div class="bff-funnel" data-r="funnel"><div class="bff-load">Loading pipeline…</div></div><div class="bff-extras"><div class="bff-actpanel" data-r="actpanel"></div><div class="bff-perfpanel" data-r="perf"></div></div><div class="bff-caret" data-r="caret" style="display:none;" title="Show all opportunities"><i class="ti ti-chevron-down" aria-hidden="true"></i></div></div><div class="bff-listcard" data-r="lc"></div>';
    ...
    function bfPipeKPI(){
      ...
      var cb=acq.length+nd.length, cr=cb?Math.round(acq.length/cb*100):0;
      function money(v){ if(!v) return '$0'; if(v>=1e6) return '$'+(v/1e6).toFixed(1)+'M'; if(v>=1e3) return '$'+Math.round(v/1e3)+'k'; return '$'+Math.round(v); }
      var kpis=[{l:'Active Deals',v:act.length.toLocaleString('en-US'),i:'ti-flame'},{l:'Pipeline Value',v:money(pipeVal),i:'ti-businessplan'},{l:'Acquired',v:acq.length.toLocaleString('en-US'),i:'ti-checks'},{l:'Close Rate',v:cr+'%',i:'ti-target-arrow'},{l:'Gross Opportunity',v:money(gross),i:'ti-trending-up'}];
