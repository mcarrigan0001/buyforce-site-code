...
(function () {
  ...
  function bfPipeRender(R){
    ...
    function ovlClose(){ if(ovl){ ovl.style.display='none'; if(ovlIf) ovlIf.src='about:blank'; } }
    ...
    function openOverlay(uuid){ ensureOverlay(); ovlList=navList(); ovlIdx=ovlList.indexOf(uuid); if(ovlIdx<0){ ovlList=[uuid]; ovlIdx=0; } ovl.style.display='block'; ovlShow(); }
    ...
    function refresh(){ render(); renderList(); updateCaret(); }
