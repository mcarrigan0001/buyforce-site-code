...
(function () {
  ...
  function bfPipeRender(R){
    ...
    var COLS=[{k:'title',t:'Vehicle'},{k:'listingLink',t:'Listing'},{k:'seller',t:'Seller'},{k:'_score',t:'Opportunity<br>Score',num:true,center:true},{k:'daysInStage',t:'Time In<br>Stage',num:true,center:true},{k:'asking',t:'Asking',num:true,money:true},{k:'offer',t:'Offer',num:true,money:true},{k:'_ovp',t:'Offer<br>Vs Price',num:true,money:true,hcenter:true},{k:'acv',t:'ACV',num:true,money:true},{k:'competition',t:'Competition'},{k:'rep',t:'Assigned Rep'},{k:'mileage',t:'Mileage',num:true},{k:'driveTime',t:'Drive Time',num:true,drive:true},{k:'offerStatus',t:'Offer Status'},{k:'offerSheetUrl',t:'Offer Sheet'}];
