...
(function () {
  ...
  function bfPipeRender(R){
    ...
    R.innerHTML='<div id="bff-wrap"><div class="bff-head"><span class="bff-title bff-glow">Command Center</span><span class="bff-scope" data-r="scope"></span><div class="bff-rt"><span class="bff-masterrep" data-r="masterrep"></span><div class="bff-tabs"><button class="bff-tab on" data-view="macro">Milestones</button><button class="bff-tab" data-view="stages">All stages</button></div></div></div><div class="bff-kpis" data-r="kpis"></div><div class="bff-rowcaret" data-row="kpis"><span class="bff-rcl">Performance KPIs</span><i class="ti ti-chevron-up bff-rcc" aria-hidden="true"></i></div><div class="bff-extras"><div class="bff-actpanel" data-r="actpanel"></div><div class="bff-perfpanel" data-r="perf"></div><div class="bff-reportpanel" data-r="report"></div></div><div class="bff-rowcaret" data-row="extras"><span class="bff-rcl">Leaderboard and Reports</span><i class="ti ti-chevron-up bff-rcc" aria-hidden="true"></i></div><div class="bff-funnel" data-r="funnel"><div class="bff-load">Loading pipeline…</div></div><div class="bff-caret" data-r="caret" style="display:none;" title="Show all opportunities"><i class="ti ti-chevron-down" aria-hidden="true"></i></div></div><div class="bff-listcard" data-r="lc"></div>'; (function(){ [].forEach.call(R.querySelectorAll('.bff-rowcaret'),function(rc){ rc.addEventListener('click',function(){ var row=rc.getAttribute('data-row'); var tg=(row==='kpis')?q('kpis'):R.querySelector('.bff-extras'); var c=rc.classList.toggle('collapsed'); if(tg) tg.style.display=c?'none':''; }); }); })();
    ...
    function bfPipeKPI(){
      ...
      bfPipeReports();
      var mrEl=q('masterrep'); if(mrEl) mrEl.innerHTML='<span class="bff-mrl">Rep</span>'+ddRep('master')+'<span class="bff-mrl">Time</span>'+ddTF('master');
