...
(function () {
  ...
  function bfPipeRender(R){
    ...
    var COLS=[{k:'title',t:'Vehicle'},{k:'seller',t:'Seller'},{k:'_score',t:'Opportunity Score',num:true},{k:'daysInStage',t:'Days in Stage',num:true},{k:'asking',t:'Asking',num:true,money:true},{k:'offer',t:'Offer',num:true,money:true},{k:'_ovp',t:'Offer vs Price',num:true,money:true},{k:'acv',t:'ACV',num:true,money:true},{k:'competition',t:'Competition'},{k:'rep',t:'Assigned Rep'},{k:'mileage',t:'Mileage',num:true},{k:'driveTime',t:'Drive Time',num:true,drive:true},{k:'offerStatus',t:'Offer Status'},{k:'listingLink',t:'Listing'},{k:'offerSheetUrl',t:'Offer Sheet'}];
    var st={view:'macro',data:null,open:null,sortK:'daysInStage',sortDir:-1,dealId:null,f:{}};
    R.innerHTML='<div id="bff-wrap"><div class="bff-head"><span class="bff-title bff-glow">Pipeline Summary</span><span class="bff-scope" data-r="scope"></span><div class="bff-rt"><button class="bff-filter" data-r="fbtn"><i class="ti ti-plus" style="color:#57c822;font-size:15px;" aria-hidden="true"></i>Filter</button><div class="bff-tabs"><button class="bff-tab" data-view="stages">All stages</button><button class="bff-tab on" data-view="macro">Macro</button></div></div></div><div class="bff-fpanel" data-r="fpanel" style="display:none;"></div><div class="bff-funnel" data-r="funnel"><div class="bff-load">Loading pipeline…</div></div></div><div class="bff-listcard" data-r="lc"></div>';
    ...
    function calcOvp(r){ var ask=Number(r.asking), off=Number(r.offer); if(isNaN(ask)||isNaN(off)) return null; return ask-off; }
    ...
    function refresh(){ render(); renderList(); }
