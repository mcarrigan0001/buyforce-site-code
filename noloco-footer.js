...
(function () {
  ...
  function buildCard(F, card){
    ...
    var priceLabel = '<div class="bf-seclbl" style="border-top:1px solid #ece9e0;margin-top:0;padding-top:5px;margin-bottom:1px;">Price &amp; Valuation</div>';
    ...
    var checklist = '<div style="border-top:1px solid #ece9e0;padding-top:5px;padding-bottom:10px;margin-bottom:1px;">' +
