...
(function () {
  ...
  function bfPipeRender(R){
    ...
    function updateCaret(){ var c=q('caret'); if(!c) return; c.style.display=(st.data&&!st.open)?'flex':'none'; }
    ...
    var _cr=q('caret'); if(_cr) _cr.addEventListener('click',function(){ st.open='__all__'; refresh(); });
    load(null);
  }
