...
(function () {
  ...
  function bfCaptureApiToken(){ try{ if(bfGetApiToken()){ try{ document.querySelectorAll('[data-bftok]').forEach(function(e){e.style.display='none';}); }catch(e){} if(window.__bfTokTimer){ clearInterval(window.__bfTokTimer); window.__bfTokTimer=null; } return; } if(bfTokTries++>40){ if(window.__bfTokTimer){ clearInterval(window.__bfTokTimer); window.__bfTokTimer=null; } return; } var rx=/bft_[A-Za-z0-9]{20,}/; var els=document.querySelectorAll('p,span,div,td,h1,h2,h3,h4,h5,h6,a,label,li'); for(var i=0;i<els.length;i++){ var el=els[i]; if(el.children.length===0){ var m=(el.textContent||'').match(rx); if(m){ try{ sessionStorage.setItem('bf.apitoken', m[0]); }catch(e){} el.setAttribute('data-bftok','1'); el.style.display='none'; try{ console.log('BF_TOKEN captured ok'); bfToast('BF auth ready \u2713'); }catch(e){} if(window.__bfTokTimer){ clearInterval(window.__bfTokTimer); window.__bfTokTimer=null; } return; } } } }catch(e){} }
